...
public class Ej3ExtraGuia7 {
    ...
    public static void main(String[] args) {
        ...
        Raices raiz=Sr.nuevaRaiz();
        Scanner leer=new Scanner(System.in);
        int menu;
        boolean flag=false;
        do{
            System.out.println("Que desea hacer?");
            System.out.println("1- Conseguir discrimintante");
            System.out.println("2- Obtener Raices");
            System.out.println("3- Salir");
            menu=leer.nextInt();
            switch (menu){
                case 1:
                    Sr.getDiscrimintante(raiz);
                    break;
                case 2:
                    Sr.calcularRaices(raiz);
                    break;
                case 3:
                    flag=true;
                    break;
