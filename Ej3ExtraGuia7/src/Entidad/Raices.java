...
public class Raices {
    ...
    private double b;
    private double c;
    private double discrimintante;

    public Raices() {
    }

    public Raices(double a, double b, double c, double discrimintante) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.discrimintante = discrimintante;
    }

    public double getDiscrimintante() {
        return discrimintante;
    }

    public void setDiscrimintante(double discrimintante) {
        this.discrimintante = discrimintante;
    }
